...
function Ribbons(options) {
    ...
    this.init = function () {
        try {
            ...
            let container = document.querySelector(this._options.container);
            if (container) {
                container.appendChild(this._canvas);
            } else {
                throw new Error('the container [' + this._options.container + '] not found');
            }
        } catch (e) {
    ...
    // Draw single section
    this._drawRibbonSection = function (section) {
        if (section) {
